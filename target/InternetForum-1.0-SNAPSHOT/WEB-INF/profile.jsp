       ...
       <main>
           ...
           <div class='profile_thread_container'>
                <div class='profile_container'>
                   ...
                   <%
                       // ログインユーザーなら
                       if (!user.isAdmin() && !loginSession.equals(user.getUserId())) {
                           out.println("<form action='profile?id=" + user.getUserId() + "'" + "method='post'>"
		                       + "<input type='submit' name='report' value='通報' class='user_report_button'>"

    ...
    <body>
       ...
       <main>
           ...
           <div class='edit_user_form_container'>
               <form class='edit_user_form_inner' action='<%= AbsolutePass.PASS + "account_info/edit?id=" + user.getUserId() %>' method='post'>
                   ...
                   <div class='profile_label'>
	                   ...
	                   <textarea id='profile' name='profile'><%= user.getProfile() %></textarea>
                   </div>
                   <%=
